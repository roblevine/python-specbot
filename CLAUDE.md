...
- Python 3.13 (backend), JavaScript ES6+ (frontend) + FastAPI 0.115.0, LangChain 0.3+, langchain-openai, langchain-anthropic, langchain-ollama, Vue 3.4.0, Vite 5.0.0 (023-add-search-tools)
- File-based JSON (backend conversations), Browser localStorage (frontend settings) - No changes required (023-add-search-tools)
