...
- [ ] T001 Install new dependencies: `langchain-community`, `duckduckgo-search`, `feedparser` in backend/requirements.txt
- [ ] T002 [P] Create tool subsystem directory structure at backend/src/services/tools/
- [ ] T003 [P] Add tool-related Pydantic schemas to backend/src/schemas.py (ToolInfo, ToolsResponse, ToolCallEvent, ToolResultEvent)
...
- [ ] T004 [P] Write unit tests for BaseTool protocol in backend/tests/unit/tools/test_base.py
- [ ] T005 [P] Write unit tests for ToolRegistry in backend/tests/unit/tools/test_registry.py

### Implementation for Foundation

- [ ] T006 [P] Implement ToolResult dataclass in backend/src/services/tools/base.py
- [ ] T007 [P] Implement BaseTool Protocol in backend/src/services/tools/base.py
- [ ] T008 Implement ToolRegistry class in backend/src/services/tools/registry.py
- [ ] T009 [P] Implement tool-specific errors (ToolError, ToolDisabledError, ToolExecutionError) in backend/src/services/tools/errors.py
- [ ] T010 Create tool subsystem __init__.py with registry export in backend/src/services/tools/__init__.py
- [ ] T011 Run foundation tests and verify they pass
...
- [ ] T012 [P] [US1] Write unit tests for WebSearchTool in backend/tests/unit/tools/test_web_search.py
...
- [ ] T014 [US1] Implement WebSearchTool class using DuckDuckGo in backend/src/services/tools/web_search.py
- [ ] T015 [US1] Register WebSearchTool in backend/src/services/tools/__init__.py
- [ ] T016 [US1] Extend llm_service.py to bind tools and implement agentic loop in backend/src/services/llm_service.py
- [ ] T017 [US1] Add ToolCallEvent and ToolResultEvent SSE emission in backend/src/api/routes/messages.py
- [ ] T018 [US1] Add logging for tool invocations in backend/src/services/tools/web_search.py
- [ ] T019 [P] [US1] Extend frontend apiClient.js to handle tool_call and tool_result SSE events in frontend/src/services/apiClient.js
- [ ] T020 [P] [US1] Add tool status indicator UI in ChatMessage.vue (show "Searching..." during tool execution) in frontend/src/components/ChatMessage.vue
- [ ] T021 [US1] Run User Story 1 tests and verify they pass
...
- [ ] T022 [P] [US2] Write unit tests for BBCNewsTool in backend/tests/unit/tools/test_bbc_news.py

### Implementation for User Story 2

- [ ] T023 [US2] Implement BBCNewsTool class using feedparser in backend/src/services/tools/bbc_news.py
- [ ] T024 [US2] Register BBCNewsTool in backend/src/services/tools/__init__.py
- [ ] T025 [US2] Add logging for BBC news tool invocations in backend/src/services/tools/bbc_news.py
- [ ] T026 [US2] Run User Story 2 tests and verify they pass
...
- [ ] T027 [P] [US3] Write contract tests for GET /api/v1/tools endpoint in backend/tests/contract/test_tools_api.py
...
- [ ] T030 [US3] Implement GET /api/v1/tools endpoint in backend/src/api/routes/tools.py
- [ ] T031 [US3] Register tools router in backend/src/api/routes/main.py
- [ ] T032 [US3] Update backend/.env.example with tool configuration variables
- [ ] T033 [US3] Run User Story 3 tests and verify they pass
